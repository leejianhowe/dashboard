...
const TICKET_ICON = `<svg width="16" height="16" viewBox="0 0 16 16"  xmlns="http://www.w3.org/2000/svg">
...
`;
@Component({
  selector: 'icon-tickets',
  templateUrl: 'tickets.component.html',
})
export class IconTickets {
  ...
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
    ...
    iconRegistry.addSvgIconLiteral(
      'tickets',
      sanitizer.bypassSecurityTrustHtml(TICKET_ICON)
    );
  }
}
